              ...
              const customToolbarItems = [
                {
                  button: {
                    component: ({ onClick, label }: { onClick: () => void; label: string }) => (
                      <button className='mx-2' onClick={onClick}><span className='h-10'>{label === 'dark' ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
